...
# ================== 多语言 ==================
TEXTS = {
    "en": {"title": "Movement AI", "upload": "Upload Image", "analyze": "Analyze", "original": "Original Image",
           "result": "Result", "angles": "Angles", "chart": "Chart", "no_pose": "No pose detected"},
    "ko": {"title": "AI 움직임 분석", "upload": "이미지 업로드", "analyze": "분석", "original": "원본",
           "result": "결과", "angles": "관절", "chart": "그래프", "no_pose": "인체 없음"},
    "zh": {"title": "运动AI分析", "upload": "上传图片", "analyze": "分析", "original": "原图",
           "result": "结果", "angles": "关节", "chart": "图表", "no_pose": "未检测到人体"}
}
