...
TEXTS = {
    "en": {
        "title": "Movement Assessment & AI Analysis Platform",
        "subtitle": "Powered by MediaPipe | Upload Image/Video for Joint Angle Analysis",
    ...
    "ko": {
        ...
        "subtitle": "MediaPipe 기반 | 이미지/비디오 업로드로 관절 각도 분석",
    ...
    "zh": {
        "title": "运动评估与AI分析平台",
        "subtitle": "基于MediaPipe | 上传图片/视频进行关节角度分析",
